<template>
  <div class="dynamic-monitoring-wrp">
    <div class="title">
      ...
      <div class="more" @click="$router.push('/yqmmpro/mining/dynamic')">
        查看更多>
      </div>
    </div>
...
<script>
  ...
  import DynamicCard from '../../yqmmpro/mining/dynamic/components/DynamicCard.vue'
  ...
  export default {
    ...
    methods: {
      async getDynamicList() {
        ...
        let res = await getBusinessRemind(params)
        if (res.code === '0') {
          this.dynamicList =
