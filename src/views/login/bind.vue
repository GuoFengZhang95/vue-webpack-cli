<template>
  <div id="login">
    <div class="header">
      <img
        src="@/assets/images/pic/platform-logo.svg"
        alt="pic"
...
<script>
  export default {
    ...
    mounted() {
      let { returnUrl } = this.$route.query
      let url = returnUrl
        ? decodeURIComponent(returnUrl)
        : window.location.origin
      this.spinning = true
      this.openId = this.getUrlQuery('openId')
      this.src = `https://globaltpl${process.env.ENV}.mumuxili.com/bind?registerPlatformId=8&openId=${this.openId}&returnUrl=${url}`
  ...
  #login {
    ...
    .login-wrp {
      ...
      .bg {
        ...
        width: 100%;
        height: 100%;
        background: url('../../assets/images/pic/login-bg-notext.png') no-repeat
          center;
      }
