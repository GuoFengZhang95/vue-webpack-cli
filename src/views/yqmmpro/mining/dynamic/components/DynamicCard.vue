      ...
      >
        ...
        <div class="dynamic-card_inner">
          <div class="dynamic-card_inner_right">
            ...
            <div
              v-if="details.relationCompanyStr || details.relationContactStr"
              class="footer"
            >
    ...
    methods: {
      ...
      onClick(details) {
        ...
        if (type == 2) {
          ...
          ;(name = 'ResearcherDetail'), (title = '科研客户详情')
        } else {
          if (cateName === '标讯') {
            //打开标讯详情
            detailComponent = BidDetail
            ;(name = 'BidDetail'), (title = '标讯详情')
          } else if (cateName === '采购意向') {
            //打开采购意向详情
            detailComponent = PurchaseDetail
            ;(name = 'PurchaseDetail'), (title = '采购意向详情')
          } else if (cateName === '资讯') {
            //打开资讯详情
            detailComponent = NewsDetail
            ;(name = 'NewsDetail'), (title = '重大商情详情')
          }
        }
