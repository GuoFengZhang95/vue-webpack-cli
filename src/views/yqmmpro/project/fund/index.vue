    ...
    >
      ...
      <template #funds>
        <TextRange
          ...
          label="自定义"
          @change="handleSPChange($event, 'funds')"
        >
          <template #left>
            <OnceFilter
              ref="defaultFunds"
      ...
      <template #createTime>
        <DateRange
          ref="customCreateTime"
          label="自定义"
          @change="handleSPChange($event, 'createTime')"
        >
          <template #left>
            <OnceFilter
              ref="defaultCreateTime"
              :list="defaultTimeList"
              :multiple="false"
              @change="handleDefaultTimeChange($event, 'createTime')"
            ></OnceFilter>
          </template>
        </DateRange>
      </template>
...
<script>
  ...
  const FundDetail = () => import('../../components/FundDetail.vue')
  ...
  const TextRange = () => import('../../components/ScreenPanel/TextRange.vue')
            ...
            res.data.list = [
              {
                id: 1,
                title:
                  'HOTAIR调控的高甲基化基因SIX3靶向AurAHOTAIR调控的高甲基化基因SIX3靶向AurAHOTAIR调控的高甲基化基因SIX3靶向AurA/B影响胶质瘤细胞有丝分裂的作用机制研究',
                level: '国家部委级',
                subject: 'E0607可再生能源与新能源利用中的工程热物理问题',
                money: '9999万元',
                people:
                  '余国伟，孙玉康，徐凯杰余国伟，孙玉康，徐凯杰余国伟，孙玉康，徐凯杰余国伟，孙玉康，徐凯杰余国伟',
                company: '浙江大学，同济大学，上海交通大学',
                citys: ['南京市', '上海市', '杭州市'],
              ...
              },
              {
                ...
                level: '国家部委级',
                subject: '可再生能源与新能源利用中的工程热物理问题',
                subjectCode: 'E0607',
                money: '9999万元',
                people: '余国伟，孙玉康，徐凯杰',
                compamy: '浙江大学，同济大学，上海交通大学',
                citys: ['南京市', '上海市', '杭州市'],
                createTime: '2022-2-22',
                endTime: '2022-2-22',
              },
      ...
      handleSPChange(e, type) {
        ...
        switch (type) {
          ...
          case 'createTime':
            ...
            this.$refs['defaultCreateTime'].reset()
            break
          case 'endTime':
            // this.pageRequestParams.minPublishTime = selectedKeys[0]
            // this.pageRequestParams.maxPublishTime = selectedKeys[1]
      ...
      handleDefaultTimeChange(e, type) {
        ...
        switch (type) {
          case 'createTime':
            ...
            this.$refs['customCreateTime'].reset()
            break
          case 'endTime':
            if (!selectedKeys[0]) {
              // this.pageRequestParams.minPublishTime = ''
