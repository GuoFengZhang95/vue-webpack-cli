    ...
    <div v-show="visible" class="school-screen-wrp">
      <div class="main">
        ...
        <div v-if="step === 'school'" class="content">
          <div v-if="searchKey && searchSchools.length" class="search-tips">
            搜索结果
          </div>
          <div
            v-if="searchKey && searchSchools.length === 0"
            class="search-tips"
          >
            暂无搜索结果
          </div>
        ...
        <div v-if="step === 'college'" class="content">
          ...
          <div class="school-college-list list-wrp">
            <div
              v-for="item in selectedSchoolItems"
              :key="item.id"
              class="college-module"
            >
      ...
      <div class="footer">
        ...
        <div v-show="step === 'school'" class="result-wrp">
          <div class="top">
            <div class="title">
              已筛选（{{ selectedSchoolKeys.length }}/{{ schoolsNum }}）
            </div>
          ...
          <div class="result-list">
            ...
            >
              ...
              <i
                class="mmxlicon mi-close icon-del"
                @click="deleteSchoolItem(item)"
              ></i>
            </div>
          </div>
        </div>
        ...
        <div v-show="step === 'college'" class="result-wrp">
          <div class="top">
            <div class="title">
              已筛选（{{ selectedCollegeKeys.length }}/{{
                currentCollegesNum
              }}）
            </div>
            <div class="reset-wrp" @click="innerReset">
...
<script>
  ...
  export default {
    ...
    watch: {},
    mounted() {
      this.searchInput = this.$lodash.debounce(this.searchInput, 1200)
    ...
    methods: {
      ...
      selectSchoolItem(school) {
        ...
        this.setTargetStatus(
          Object.assign({}, school, { checked: !checked }),
          this.schools
        )
        if (!checked) {
      ...
      selectCollege(college) {
        ...
        this.setTargetStatus(
          Object.assign({}, college, { checked: !checked }),
          this.colleges
        )
        if (!checked) {
      ...
      setCollegeSelectedItems(college) {
        let schoolName = this.selectedSchoolItems.filter(
          school => school.id == college.companyId
        )[0].name
      ...
      confirm() {
        ...
        if (this.step === 'school') {
           ...
           */
          const targetUnSelectCollegeSchoolsIds = Object.keys(
            this.colleges
          ).filter(
            schoolId =>
              !this.selectedCollegeItems.some(
                collegeItem => collegeItem.companyId == schoolId
              )
          )
          ...
          if (
            ...
            targetUnSelectCollegeSchoolsIds.length <
              Object.keys(this.colleges).length
          ) {
            ...
            let params = {
              ...
              selectedCollegeKeys: [
                ...this.selectedCollegeKeys,
                ...extraSelectedCollegeIds,
              ],
