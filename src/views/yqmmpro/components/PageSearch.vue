      ...
      <div class="search-left">
        ...
        <div class="search-content">
          ...
          <transition name="fade">
            <div
              v-show="searchLogVisible && searchLogList.length"
              class="search-log-wrp"
            >
  ...
  export default {
    ...
    methods: {
      async updateHotSearch(searchType) {
        ...
        this.$nextTick(() => {
          this.$store.dispatch(
            'app/setPageSearchRect',
            this.$refs['pageSearch'].getBoundingClientRect()
          )
        })
      },
