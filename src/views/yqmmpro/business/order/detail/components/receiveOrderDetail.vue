<template>
  <div id="order-detail">
    <MuDrawer v-model="drawerVisible" :title="drawerTitle" min-width="900px">
          ...
          <div class="info-wrap">
            <div class="user-name-wrap">
              <div>
                ...
                <span
                  class="tag tag-green"
                  :class="colorStatus[renderObj.orderStatus]"
                >
            ...
            <a-col span="24">
              <div class="order-introduction">
                ...
                <div v-if="!isString" class="demension-list">
                  <div
                    v-for="(item, index) in demensionList"
                    :key="index"
                    class="demension-item"
                  >
...
<script>
  import { getOrderDetail, getOrderFiles } from '@/api/yqmmPro/business'
        ...
        getOrderDetail({ id: this.acceptId }).then(res => {
          ...
          if (res.data.advantage) {
            try {
              ...
              if (
                typeof this.advantage == 'object' &&
                this.advantage.constructor == Array
              ) {
