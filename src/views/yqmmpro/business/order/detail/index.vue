...
<script>
  import OrderTable from './components/receiveOrderTable.vue'
  import File from './components/File.vue'
  import { getBusinessDetail, getFilesList } from '@/api/yqmmPro/business'
  ...
  export default {
    ...
    methods: {
      // flag: 是否新增; title: 侧拉标题; id: 编辑文章的id, rowId: 每一条数据的id
      show(flag, title, id, lockId, rowId) {
        this.orderId = id
        this.lockId = lockId
        this.rowId = rowId
      ...
      getDemandDetail() {
        getBusinessDetail({ id: this.orderId }).then(res => {
          ...
          this.renderObj.advantage =
            this.renderObj.description &&
            this.renderObj.description.replace(/\n/g, '<br/>')
