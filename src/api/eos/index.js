...
import { EOS_VARIABLE } from '../globalVariable'
...
export function getProductList(data) {
  Object.assign(data, { source: EOS_VARIABLE.source })
  return request({
...
export function createOrder(data) {
  Object.assign(data, {
    ordergenre: EOS_VARIABLE.ordergenre,
    source: EOS_VARIABLE.source,
  })
  return request({
...
export function getOrderList(data = {}) {
  Object.assign(data, { type: EOS_VARIABLE.type, source: EOS_VARIABLE.source })
  return request({
    url: '/eos/order/list',
    method: 'get',
    params: data,
...
export function getInvoiceApplicationList(data) {
  Object.assign(data, {
    source: EOS_VARIABLE.source,
    ordergenre: EOS_VARIABLE.ordergenre,
    orderType: EOS_VARIABLE.orderType,
  })
  return request({
