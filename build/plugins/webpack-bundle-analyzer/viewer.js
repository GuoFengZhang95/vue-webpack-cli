...
async function startServer(bundleStats, opts) {
  ...
  await new Promise(resolve => {
    server.listen(port, host, () => {
      ...
      logger.info(
        `${chalk.bold('Webpack Bundle Analyzer')} is started at ${chalk.bold(url)}\n` +
...
async function generateReport(bundleStats, opts) {
  ...
  logger.info(`${chalk.bold('Webpack Bundle Analyzer')} saved report to ${chalk.bold(reportFilepath)}`)
...
async function generateJSONReport(bundleStats, opts) {
  ...
  logger.info(`${chalk.bold('Webpack Bundle Analyzer')} saved JSON report to ${chalk.bold(reportFilename)}`)
}
